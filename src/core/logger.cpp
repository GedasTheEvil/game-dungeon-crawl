...
template<typename... Args>
void Logger::debugf(const std::string& category, const std::string& format, Args... args) {
    debug(category, formatString(format, args...));
}

template<typename... Args>
void Logger::infof(const std::string& category, const std::string& format, Args... args) {
...
template<typename... Args>
void Logger::errorf(const std::string& category, const std::string& format, Args... args) {
...
template void Logger::warningf<const char*, unsigned short>(const std::string&, const std::string&, const char*, unsigned short);
template void Logger::infof<unsigned int>(const std::string&, const std::string&, unsigned int);
template void Logger::errorf<const char*, const char*>(const std::string&, const std::string&, const char*, const char*);
