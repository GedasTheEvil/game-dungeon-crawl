...
Monsters add their threat (`monsterThreat`: rat 0.6, scarab 1, plant 1.5, worm 2.5, giant rat 3, Anubis 8):
...
4. **Content.** Along the part of each corridor the player has to cross: spike pits to jump, spikes, rock
   ...
   unlock with the difficulty: rat and scarab from 1, plant and worm from 3, giant rat from 4, Anubis from 8.
...
Examples: `tests/levels/mechanisms.txt`, `tests/levels/rats.txt` (the built files sit next to them).
